...
//Appel de la fonction creationFiche pour créer la fiche pour cet utilisateur et ce mois ci
creationFiche();
...
//On rempli la fiche de frais  grâce la fonction remplirFiche
remplirFiche($id, $mois, $quantite);
